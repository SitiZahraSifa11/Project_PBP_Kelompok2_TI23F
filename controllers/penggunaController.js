...
//     const user = users[0]; // Ambil pengguna pertama (karena email seharusnya unik)
...
//     // Respon berhasil login tanpa token
//     res.status(200).json({
...
//   db.query('SELECT id, nama, email FROM pengguna', (error, results) => {
//     if (error) {
